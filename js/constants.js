    ...
    raw: {
        ...
        province: {
            ...
            identified: {
                ...
                chris: `SELECT ${COL.CORRECT_SUB_AREA}, COUNT(${COL.CORRECT_SUB_AREA}) WHERE ${COL.CORRECT_SUB_AREA}=${COL.GUESS_SUB_AREA} AND ${COL.PLAYER}='${PLAYER.ERIC}' GROUP BY ${COL.CORRECT_COUNTRY}, ${COL.CORRECT_SUB_AREA}`, // only counts countries you've gotten correct
            },
            misidentified: {
